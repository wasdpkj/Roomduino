...
RF24 radio(9, 10); //设置24L01的CE和CSN引脚
...
void menu(void)
{
  ...
  {
    //    u8g.drawStr(40, 9, "MENU");

    u8g.drawFrame(0, 0 + (13 * MENU_xuan0), 128, 12);		//选框

    u8g.setPrintPos(5, 11 + 13 * 0);
    u8g.print("CONFIG MOD");
    u8g.setPrintPos(5, 11 + 13 * 1);
    u8g.print("CONFIG TIME");
    u8g.setPrintPos(5, 11 + 13 * 2);
    u8g.print("CONFIG DS");
    u8g.setPrintPos(5, 11 + 13 * 3);
    u8g.print("CONFIG CON");
    u8g.setPrintPos(5, 11 + 13 * 4);
  ...
  {
    u8g.drawFrame(0, 0 + (13 * MENU_xuan1), 128, 12);		//选框
  ...
  {
    u8g.drawFrame(0, 0 + (13 * MENU_xuan2), 128, 12);		//选框
